<!-- Customizable Blog Template Project By: Brandon Meyer -->
<?php
session_start();
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">    <title>Customize Template Project</title>
  ...
  <body onload="init();">
      ...
      <div class="container">
        <nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse">
          ...
          <div class="row pull-right">  
            <a class="navbar-brand btn btn-secondary" id="member-login" href="login.html">Login</a>   
          ...
          <form method="post">
            ...
            <a id="save-button" href='#' onclick='main.saveBlog()'><i class="fa fa-2x fa-save"></i></a>
    ...
    <div class="blog-header">
      <div class="container">
        ...
        <p class="lead blog-description">A customizable example blog built with Bootstrap, JavaScript, PHP, & MySQL.</p>
        <p>You may select a theme by replacing the title with German, Italian or English.</p>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="blog-post">
            ...
            <div id="editBtn"></div>
            <p id="dateBlog" class="blog-post-meta">January 1, 2014 by <a href="#">Mark</a></p>
            <div id="editPost">
    ...
    <!-- Bootstrap template credit goes to @mdo -->
    <footer class="blog-footer">
      <center>
          <p>Customizable Blog Template Project By: Brandon Meyer</p>
          <p>
